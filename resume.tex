...
Responsible for the development of CVR prediction models for the display ads. Experienced data aggregation using Hive on a Hadoop cluster, development of machine learning models using Jupyter Notebook and Python, construction of DevOps and MLOps pipelines using CI/CD with Argoworkflow, Airflow, and Screwdriver, and A/B testing in the production environment.
    }
...
\cvcomputer{Industry Knowledge}{
    ...
    Python, Apache Hive, Apache Hadoop, C++, Vim, \LaTeX, Git, Docker
}
