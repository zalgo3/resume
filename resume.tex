...
\firstname{Hiroki}
\familyname{Tanabe}
\title{JSPS Research Fellow (DC1) / PhD Student at Kyoto University / Researcher of Mathematical Optimization / YouTuber}
\IfFileExists{.personal_data.tex}{
\input{.personal_data.tex}
}{
\input{.personal_data_sample.tex}
}
\homepage{zalgo-official.com/en/curriculum-vitae}
...
\cvcomputer{Operations Research}{Multiobjective optimization, continuous optimization, convex optimization, non-convex optimization, nonsmooth optimization, nonlinear optimization, first-order methods, proximal methods, descent methods, merit functions}{Machine Learning}{Sparse modelling, Image processing, Python, Jupyter, scikit-learn, scikit-image, OpenCV, Numpy, SciPy, Matplotlib, seaborn, Pandas}
\vspace{-2em}
\cvcomputer{}{}{Other Technologies}{\LaTeX, Vim, Git, Docker, Ruby on Rails, GitHub Actions}
...
\cventry{\yearabove{\shortmonthname[10]}{2019}--Present}{PhD, Computer Science (expected \shortmonthname[9] 2022)}{Kyoto University}{Kyoto, Japan}{}{}
...
\section{Experience}
\cventry{\yearabove{\shortmonthname[4]}{2020}--Present}{Research Fellowship for Young Scientists (DC1)}{Japan Society for the Promotion of Science}{Tokyo, Japan}{}{
Awarded to excellent PhD students, this fellowship allows the fellows to focus on a freely chosen research topic based on their innovative ideas. This program's recruitment phase has a very narrow selection process with a selection ratio of 20\%.\newline{}
...
\cventry{\yearabove{\shortmonthname[2]}{2017}--Present}{YouTuber}{}{}{}{
    Manage two YouTube channels, the \httplink[Let's Play channel]{youtube.com/c/zalgo33} with 17,000 subscribers and the \httplink[Music Cover channel]{youtube.com/c/zalgosing} with 5,000 subscribers. \httplink[One Let's Play video]{youtube.com/watch?v=_h3crP83iNk} has more than 1 million views.
}
...
\subsection{Papers}
\cvlistitem{Hiroki Tanabe, Ellen H. Fukuda, and Nobuo Yamashita, Convergence rates analysis of a multiobjective proximal gradient method. \textit{Optimization Letters}, Online first, 2022. [\httplink[doi]{doi.org/10.1007/s11590-022-01877-7}, \httplink[pdf]{rdcu.be/cL1Kg}]}
...
\cvlistitem{Hiroki Tanabe, Ellen H. Fukuda, and Nobuo Yamashita, New merit functions for multiobjective optimization and their properties. \textit{Submitted}, 2022. [\httplink[pdf]{arxiv.org/abs/2010.09333}]}
\cvlistitem{Hiroki Tanabe, Ellen H. Fukuda, and Nobuo Yamashita, An accelerated proximal gradient method for multiobjective optimization. \textit{Submitted}, 2022. [\httplink[pdf]{arxiv.org/abs/2202.10994}]}
